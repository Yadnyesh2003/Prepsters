        ...
        if (user && !hasCheckedProfile) {
            const calculateCompletion = async () => {
                ...
                try {
                    ...
                    // Check if profile is fully completed (including resume)
                        ...
                        >
                            <div className="flex-1 w-full p-4">
                                ...
                                <ol className="list-decimal list-inside text-xs sm:text-sm text-gray-900 space-y-2 pl-5">
                                    ...
                                    <li>
                                        Complete your profile including uploading at least one resume to access all features.
                                    </li>
                                </ol>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden transform transition-all duration-300 scale-95 hover:scale-100">
                        ...
                        <div className="p-6">
                            <p className="text-gray-600 mb-6 text-center">
                                To unlock all features and personalized content, please complete your profile setup including uploading at least one resume.
                            </p>
                            ...
                            <div className="space-y-3 mb-6">
                                {[
                                    { label: 'Email', completed: profileCompletion >= 15 },
                                    { label: 'Name', completed: profileCompletion >= 25 },
                                    { label: 'Avatar', completed: profileCompletion >= 35 },
                                    { label: 'Institution', completed: profileCompletion >= 50 },
                                    { label: 'Year & Branch', completed: profileCompletion >= 70 },
                                    { label: 'Resume Upload', completed: profileCompletion >= 100 }
                                ].map((item, index) => (
