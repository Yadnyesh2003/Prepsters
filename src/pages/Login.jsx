...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-[#1E2A38] to-[#243A5A] px-4">
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
                {/* Header */}
                <h2 className="text-3xl font-bold text-[#005F73] text-center mb-6">
                    Welcome Back
                </h2>
                <p className="text-gray-600 text-center mb-4">Login to your account</p>
                ...
                <div className="text-center mt-5">
                    <p className="text-gray-600">
                        ...
                        <Link to="/signup" className="text-[#005F73] font-medium hover:underline">
                            Sign Up
                        </Link>
                    </p>
                    <p className="mt-2">
                        <Link to="/forgot-password" className="text-[#005F73] font-medium hover:underline">
                            Forgot Password?
                        </Link>
                    </p>
                </div>
