  ...
  return (
    <div className='flex items-center justify-between px-4 md:px-8 border-b border-gray-500 py-3'>
      ...
      <div className="flex gap-4">
        <button 
          className={`py-2 px-4 rounded-4xl hover:bg-blue-300 ${activeButton === 'add' ? 'bg-indigo-500 text-white' : 'bg-gray-200'}`} 
          onClick={() => {handleButtonClick('add')}}>
          Add Content
        </button>
        <button 
          className={`py-2 px-4 rounded-4xl hover:bg-blue-300 ${activeButton === 'view' ? 'bg-indigo-500 text-white' : 'bg-gray-200'}`} 
