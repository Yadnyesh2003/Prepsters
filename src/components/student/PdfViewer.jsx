    ...
    return (
        <div className="fixed inset-0 backdrop-blur-sm flex justify-center items-center z-50">
            <div className='bg-white w-full sm:w-3/4 md:w-3/4 lg:w-3/4 xl:w-3/4 2xl:w-3/4 h-full rounded-lg overflow-hidden border-2 border-indigo-700'>
                ...
                {/* PDF viewer with all interactive features disabled */}
                <iframe
                    ...
                    frameBorder="0"
                    scrolling="no"
                    // Disable all interactive features and permissions
                    allow=""
                    allowFullScreen={false}
                    // Disable context menu and text selection
                    onContextMenu={(e) => e.preventDefault()}
                    style={{ 
                        pointerEvents: 'auto', // Keep basic scrolling but disable other interactions
                        userSelect: 'none'
                    }}
                />
            </div>
